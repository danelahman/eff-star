...
val equiv (#a:Type) (#ops:sig) (t1 t2:template_repr a ops) : prop

val refl (#a:Type) (#ops:sig) (t:template_repr a ops)
  : Lemma (t `equiv` t)
          [SMTPat (t `equiv` t)]

val sym (#a:Type) (#ops:sig) (t1 t2:template_repr a ops)
  : Lemma (requires (t1 `equiv` t2))
          (ensures  (t2 `equiv` t1))
          [SMTPat (t2 `equiv` t1)]

val trans (#a:Type) (#ops:sig) (t1 t2 t3:template_repr a ops)
...
val op_cong (#a:Type) (#ops:sig) 
            ...
            (t1 t2:arity_of op -> template_repr a ops)
